...
export default {
    ...
    mounted() {
        this.front_canvas = `http://localhost:3000/images/${this.data_.shirt_path.front}.png`
        this.back_canvas = `http://localhost:3000/images/${this.data_.shirt_path.back}.png`
    ...
    methods: {
        ...
        Response(slide, type) {
            axios.get(`http://localhost:3000/services/arm_service/shirts/home`)
                .then(response => {
